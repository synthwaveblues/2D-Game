...
const dash_ghosting = preload("res://scenes/dash_ghosting.tscn")
@onready var player = $"."
...
func add_ghost():
	...
	if animation.flip_h == true:
		...
		direction2 = false
	var ghost = dash_ghosting.instantiate()
	ghost.set_property(position, player.scale,direction2)
...
func _on_dash_timer_timeout():
	ghost_timer.stop()
	dash_particles.emitting = false # Replace with function body.
